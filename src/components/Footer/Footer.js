      ...
      <div className="container">
        <div className="columns">
          <div className="column is-size-7">
            <p className='has-text-weight-semibold'>CONTÁCTANOS</p>
             <p>
               ...
               </span> 01 800-600-0009
              </p>
              <p>
              <a><span className='icon is-large'>
          ...
          <div className="column is-size-7 has-text-centered">
            ...
            <p><span className='has-text-weight-semibold'>Lunes a viernes: </span>09:00 a las 18:30 hrs.</p>
            <p><span className='has-text-weight-semibold'>Sábados:</span> 09:30 a 13:30 hrs.</p>
            <br />
            <br/>
            <p>
              <button className='button is-link is-small'>¡SOLICITA TU PRÉSTAMO AQUÍ!</button>
            </p>
          </div>
          <div className="column is-size-7">
          <div className='is-pulled-right'>
            ...
            <p>
              ...
              <p> <a className='underlined'>Términos y condiciones</a>
            </p>
            </div>
          </div>
        </div>
        ...
        <div className='group has-text-centered'>
          ...
          <br/>
          <p className='is-size-5'>Financiera Independencia S.A.B. de C.V. SOFOM. E.N.R.</p>
